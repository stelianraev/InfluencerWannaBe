...
namespace InfluencerWannaBe.Data.Migrations
{
    ...
    [Migration("20220324121919_AddPublisherLogic")]
    partial class AddPublisherLogic
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InfluencerOffer", b =>
                {
                    b.Property<int>("SignUpInfluencersId")
                        .HasColumnType("int");

                    b.Property<int>("SignUpOffersId")
                        .HasColumnType("int");

                    b.HasKey("SignUpInfluencersId", "SignUpOffersId");

                    b.HasIndex("SignUpOffersId");
            ...
            modelBuilder.Entity("InfluencerOffer", b =>
                {
                    b.HasOne("InfluencerWannaBe.Data.Models.Influencer", null)
                        .WithMany()
                        .HasForeignKey("SignUpInfluencersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InfluencerWannaBe.Data.Models.Offer", null)
                        .WithMany()
                        .HasForeignKey("SignUpOffersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
