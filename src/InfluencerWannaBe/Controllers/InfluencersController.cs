namespace InfluencerWannaBe.Controllers
{
    ...
    public class InfluencersController : Controller
    {
        ...
        public IActionResult AddAccaunt(InfluencerRegistrationFormModel influencer, IFormFile photo)
        {
            ...
            {
                Helper.Logs($"Error: {ex}" + DateTime.Now.ToString("dd-MM-yyyy hh:mm:ss"), "InfluencerController_AddAccaunt" + DateTime.Now.ToString("dd-MM-yyyy hh:mm:ss"));
            }
        ...
        public IActionResult Influencers([FromQuery] AllInfluencersQueryModel query)
        {
            ...
            {
                Helper.Logs($"Error: {ex}" + DateTime.Now.ToString("dd-MM-yyyy hh:mm:ss"), "InfleuncerController_Influencers" + DateTime.Now.ToString("dd-MM-yyyy hh:mm:ss"));
            }
        ...
        {
            ICollection<OffersListingViewModel> offers = null;
            try
            {
                offers = this.offerService.OffersBySignInInfluencer(this.User.GetId());
            }
            catch (Exception ex)
            {
                Helper.Logs($"Error: {ex}" + DateTime.Now.ToString("dd-MM-yyyy hh:mm:ss"), "InfleuncerController_SignInOffers" + DateTime.Now.ToString("dd-MM-yyyy hh:mm:ss"));
            }
